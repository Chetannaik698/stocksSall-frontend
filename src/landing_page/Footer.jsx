...
const Footer = () => {
  return (
    <>
      <div className="container mt-5 footer-container border-top py-4">
        <div className="row ">
          <div className="col-md col-12">
            ...
            <br />
            <i className="fa-brands fa-youtube mt-3"></i>
            <i className="fa-brands fa-whatsapp"></i>
            <i className="fa-brands fa-telegram"></i>
          </div>
          <div className="col-md col-12 f-col">
            <h5>Company</h5>
            <a href="#">About</a> <br />
      ...
      <div
        className="mt-5 text-muted container footer-p"
        style={{ fontSize: "14px" }}
      >
        <p>
